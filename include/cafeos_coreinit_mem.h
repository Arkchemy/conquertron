 ...
 * space is only 256MB. */
/* Back at 0x4000000. It was moved to 0x11000000 when data sections were given
 * their real addresses, so the heap would not cover the game's own globals;
 * that change broke the boot and was reverted, and with data synthetic again
